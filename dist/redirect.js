...
function prepareLinks(linkCheck, slug, newUrl) {
    ...
    for (var i = 0; i < links.length; i++) {
        ...
        var d = JSON.parse('{"' + search.replace(/&/g, '","').replace(/=/g, '":"') + '"}', function (key, value) {
...
function buildLinks() {
    ...
    if (env == "dev") {
        ...
        links["web"] = {
            store: "https://web.dev.thekinapp.com/home/kins/{slug}/{uid}?&redirect={qpenc}",
            launch: "https://web.dev.thekinapp.com/home/kins/{slug}/{uid}?&redirect={qpenc}",
        ...
        links["web"] = {
            store: "https://web.thekinapp.com/home/kins/{slug}/{uid}?&redirect={qpenc}",
            launch: "https://web.thekinapp.com/home/kins/{slug}/{uid}?&redirect={qpenc}",
            redirect: "/clickfrommobile"
        };
    }
    return links;
